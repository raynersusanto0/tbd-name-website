...
export default function Home() {
  return (
    <div>
       <div className="grid grid-rows justify-items-center p-8 pb-5 gap-5 min-h-screen sm:p-20">
        <main className="flex flex-col gap-8 items-center row-start-1 sm:items-center w-full max-w-7xl">
          ...
          <div className="flex items-center flex-col sm:flex-row">
            <h2 className="text-xl text-center"> At Pandu Web, we prioritize your convenience and satisfaction over any other factor. We believe that software solutions must be beneficial for our clients and give them an easier time, not a headache. </h2> 
          </div>
      ...
      <section className="mx-auto w-full pt-10 bg-gray-200">
